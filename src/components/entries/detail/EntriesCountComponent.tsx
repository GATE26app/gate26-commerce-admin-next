...
function EntriesCountComponent({ EntriesData, setEntriesData }: Props) {
  return (
    <Flex w={'100%'} flexDirection={'column'} mb={'30px'}>
      ...
      >
        <InputBox
          ...
          w={'310px'}
          value={
            EntriesData.limitCnt == 0 ? '' : intComma(EntriesData.limitCnt)
          }
          onChange={(e) =>
            setEntriesData({
              ...EntriesData,
              limitCnt: Number(e.target.value.replace(/[^0-9]/g, '')),
            })
          }
...
export default EntriesCountComponent;
