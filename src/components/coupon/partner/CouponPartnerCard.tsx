...
function CouponPartnerCard({ header, item, index, pageNo, totalCount }: Props) {
        ...
        >
          <Flex flexDirection={'row'} alignItems={'center'} gap={'10px'}>
            <Flex
              ...
              cursor={'pointer'}
              onClick={() =>
                router.push(`/coupon/partner/detail?id=${item.couponId}`)
              }
            >
...
export default CouponPartnerCard;
