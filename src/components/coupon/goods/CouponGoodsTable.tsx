...
import { couponGoodsListheader } from '@/utils/headerData';
import CouponGoodsSkeletonCard from './CouponGoodsSkeletonCard';
import CouponGoodsCard from './CouponGoodsCard';
...
function CouponGoodsTable({ data }: Props) {
      ...
      {!data ? (
        <>
          {Array(7)
            .fill(0)
            .map(() => {
              return <CouponGoodsSkeletonCard header={couponGoodsListheader} />;
            })}
        </>
      ) : (
        <>
...
export default CouponGoodsTable;
