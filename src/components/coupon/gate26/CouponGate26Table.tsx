...
import CouponGate26SkeletonCard from './CouponGate26SkeletonCard';
import CouponGate26Card from './CouponGate26Card';
import {
  CouponDataType,
  CouponListReqType,
  CouponListResType,
} from '@/app/apis/coupon/CouponApi.type';
import { couponGate26Listheader } from '@/utils/headerData';
...
function CouponGate26Table({ data }: Props) {
      ...
      {!data ? (
        <>
          {Array(7)
            ...
            .map(() => {
              return (
                <CouponGate26SkeletonCard header={couponGate26Listheader} />
              );
            })}
        </>
      ) : (
...
export default CouponGate26Table;
