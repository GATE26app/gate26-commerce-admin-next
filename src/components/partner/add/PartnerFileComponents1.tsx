...
function PartnerFileComponent1({ EntriesData, setEntriesData, idx=0 }: Props) {
  ...
  const imgAxios = async () => {
    console.log('files dTA - ', EntriesData[0].thumbnailImagePath)
    console.log('token', getToken().access);
...
export default PartnerFileComponent1;
