...
function PartnerConnectInfo({ info }: { info: PartnersParamsType }) {
        ...
        <>
          ...
          <Flex mt={'30px'} flexDirection={'column'}>
            ...
            <Flex flexDirection={'row'} pb={'20px'} width={'100%'}>
              ...
              <Flex flexDirection={'column'} width={'100%'}>
                <Textarea
                  ...
                  onChange={(e) => {
                    setValue('adminMemo', e.target.value);
                  }}
                  maxLength={500}
                  height={150}
            ...
            <Grid templateColumns="repeat(2, 1fr)">
              ...
              <GridItem>
                <Flex flexDirection={'row'} pb={'20px'} alignItems={'center'}>
                  ...
                  <Text color={ColorBlack} fontWeight={400} fontSize={'15px'}>
                    {info.loginDate
                      ? moment(info.loginDate).format('YYYY-MM-DD')
                      : '-'}
                  </Text>
                </Flex>
              </GridItem>
            ...
            <Flex flexDirection={'row'} pb={'20px'}>
              ...
              <Text color={ColorBlack} fontWeight={400} fontSize={'15px'}>
                {info.resignRequestDate
                  ? moment(info.resignRequestDate).format('YYYY-MM-DD')
                  : '-'}
              </Text>
            </Flex>
